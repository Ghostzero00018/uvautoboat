...
## Fallback queue progress (while A pending, ~10:30 → 12:00)

While A's weather confirmation stayed pending past the 12:00 cutoff, two fallback-queue items from §"Fallback if A=NO-GO" (above) landed end-to-end. Today's commit stack at 12:12, three commits on top of Mon-evening's `4ea187a`:
