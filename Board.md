...
| Install Mission Planner + QGroundControl on Linux workstation (prof-requested 23/04 toolchain) | ✅ 24/04/2026 — MP 1.3.9384.38258 + QGC stable AppImage 09/10/2025; MP-under-Mono reaches main UI but GDAL / OGR / OSR fail (terrain + advanced geo-ref degraded — Windows `.msi` fallback held if prof needs GIS demos) |
...
**Document Version**: 9.10 | **Last Updated**: 11/05/2026
