...
- **[Live Hailo and MAVROS Dashboard Testing](Live_Hailo_MAVLink_Dashboard_Testing)** — bounded view-only procedure that starts workstation dashboard services before the external Pi Hailo/MAVROS helper.
